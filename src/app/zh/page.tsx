      ...
      <footer className="site-footer">
        <div className="footer-inner">
          <div className="footer-brand">
            ...
            <span className="footer-name">AI 代理團隊</span>
          </div>
          <div className="footer-tagline">自主 AI · 24/7 運行 · 企業級安全</div>
          ...
          <p className="footer-copy">&copy; {new Date().getFullYear()} AI 代理團隊 · 由 Cardano 驅動 · contact@example.com</p>
        </div>
      </footer>
    </main>
  );
