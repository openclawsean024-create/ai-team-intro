...
市場不是沒有需求，而是現有競品 CrewAI、ChatGPT Team、Claude for Teams 已覆蓋原本寬泛的功能。體檢找到的缺口是：企業端需要資安與 SOC 2；CrewAI 已進入大量 Fortune 500，而「8 種產業 persona」過於模糊，單純介紹 AI 角色沒有購買理由。
...
|---|---|---|---|---|
| Primary | 10 位 pilot | 已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。 | 每週固定工作 | 願意提供真實資料並重做 |
| Secondary | 5 位 adjacent | 相鄰工具使用者 | 目前用競品或表格 | 願意切換/匯出 |
| Buyer/Influencer | 3–5 位 | 顧問、主管或校園/社群 | 替他人推薦工具 | 願意安排 demo |

### 1.3 核心價值主張 (Value Proposition)

> 「不賣 AI 團隊名詞或模板市集，只提供一個「工作流責任矩陣」：把一人公司的固定任務、輸入、人工檢查點與可用工具寫成可執行的 operating playbook。」
這個主張直接回應 sweet=2：不是複製 CrewAI、ChatGPT Team、Claude for Teams 的主功能，而是聚焦「企業端需要資安與 SOC 2；CrewAI 已進入大量 Fortune 500，而「8 種產業 persona」過於模糊，單純介紹 AI 角色沒有購買理由。」所留下的可驗證空間。
...
- ❌ 不做企業級 Agent 執行平台
- ❌ 不做 SOC 2、SSO、審計與多租戶承諾
- ❌ 不做 8 種產業的泛 persona 模板
- ❌ 不做模板市集、創作者分成或社群
- ❌ 不做對話同步與瀏覽器擴充功能第一版
- ❌ sweet=2，任何付費開發前須先驗證責任矩陣是否被反覆使用
...
#### US-001：任務目錄：每個任務一個 owner、輸入、輸出與人工檢查點
> As a 已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。
> I want 任務目錄：每個任務一個 owner、輸入、輸出與人工檢查點
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-002：五種真實 playbook：內容、客戶回覆、產品規格、開發、週報
> As a 已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。
> I want 五種真實 playbook：內容、客戶回覆、產品規格、開發、週報
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-003：角色不是 AI 人格，而是工作責任與工具清單
> As a 已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。
> I want 角色不是 AI 人格，而是工作責任與工具清單
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-004：依任務記錄實際完成時間與工具成本
> As a 已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。
> I want 依任務記錄實際完成時間與工具成本
> So that 我能在不改變原有工作習慣下完成一個可交付結果。
...
#### US-006：一鍵複製模板與 Markdown/JSON 匯出
> As a 已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。
> I want 一鍵複製模板與 Markdown/JSON 匯出
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-007：任務版本、決策理由與變更紀錄
> As a 已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。
> I want 任務版本、決策理由與變更紀錄
> So that 我能在不改變原有工作習慣下完成一個可交付結果。
...
本 MVP 由 sweet=2 重新定義：只保留「不賣 AI 團隊名詞或模板市集，只提供一個「工作流責任矩陣」：把一人公司的固定任務、輸入、人工檢查點與可用工具寫成可執行的 operating playbook。」所需的最短閉環，不做競品已主導的廣泛功能。
#### FR-001：任務目錄：每個任務一個 owner、輸入、輸出與人工檢查點（MUST）
- 目的：將 任務目錄：每個任務一個 owner、輸入、輸出與人工檢查點 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-002：五種真實 playbook：內容、客戶回覆、產品規格、開發、週報（MUST）
- 目的：將 五種真實 playbook：內容、客戶回覆、產品規格、開發、週報 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-003：角色不是 AI 人格，而是工作責任與工具清單（MUST）
- 目的：將 角色不是 AI 人格，而是工作責任與工具清單 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-004：依任務記錄實際完成時間與工具成本（MUST）
- 目的：將 依任務記錄實際完成時間與工具成本 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-005：流程圖可視化但不自動執行（MUST）
- 目的：將 流程圖可視化但不自動執行 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-006：一鍵複製模板與 Markdown/JSON 匯出（MUST）
- 目的：將 一鍵複製模板與 Markdown/JSON 匯出 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-007：任務版本、決策理由與變更紀錄（MUST）
- 目的：將 任務版本、決策理由與變更紀錄 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-008：本地 IndexedDB，明確標示不等於企業合規產品（MUST）
- 目的：將 本地 IndexedDB，明確標示不等於企業合規產品 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-009：每週回顧頁，顯示卡住的責任交接（MUST）
- 目的：將 每週回顧頁，顯示卡住的責任交接 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-010：用 10 位使用者的實際任務資料驗證模板（MUST）
- 目的：將 用 10 位使用者的實際任務資料驗證模板 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。
...
- P1-01 雲端同步與分享連結：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-02 顧問客戶 workspace 對照表：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-03 Slack/Notion 單向匯出：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-04 playbook 完成率與 bottleneck 分析：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-05 可列印的 SOP 報告：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-06 小型團隊 3 席方案：只有在 MVP 指標達標且有 3 個以上相同請求時排入。

### 3.3 v3（探索，P2）

- P2-01 企業治理 connector：不承諾時程，需重新檢查競品與合規。
- P2-02 權限與審計：不承諾時程，需重新檢查競品與合規。
- P2-03 Agent 執行 adapter：不承諾時程，需重新檢查競品與合規。
- P2-04 模板交易：不承諾時程，需重新檢查競品與合規。

### 3.4 ⭐ Acceptance Criteria (Given / When / Then)

**AC-001：建立一個任務必填輸入、輸出、責任人與檢查點**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「建立一個任務必填輸入、輸出、責任人與檢查點」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-002：匯入五種 playbook 後可編輯而不覆蓋原始模板**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「匯入五種 playbook 後可編輯而不覆蓋原始模板」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-003：每次完成任務都可記錄工具與分鐘數**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「每次完成任務都可記錄工具與分鐘數」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-004：工作流圖與文字列表內容一致**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「工作流圖與文字列表內容一致」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-005：缺少人工檢查點的任務顯示風險警告**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「缺少人工檢查點的任務顯示風險警告」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-006：匯出的 JSON 可在新瀏覽器完整還原**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「匯出的 JSON 可在新瀏覽器完整還原」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-007：刪除任務不會刪除其他任務的歷史**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「刪除任務不會刪除其他任務的歷史」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-008：同一 playbook 更新後舊版仍可讀取**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「同一 playbook 更新後舊版仍可讀取」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-009：成本計算器不把 ChatGPT/Claude 月費重複計入每次任務**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「成本計算器不把 ChatGPT/Claude 月費重複計入每次任務」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-010：分享連結預設唯讀且不包含私人對話**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「分享連結預設唯讀且不包含私人對話」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。
...
|---|---|---|---|---|
| GET | /data/playbooks.json | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/playbooks/export | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/playbooks/import | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/tasks/:id/log | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| GET | /api/dashboard | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/share-snapshots | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
...
| 風險 | 等級 | 早期訊號 | 緩解 | 停止/轉向 |
|---|---|---|---|---|
| CrewAI/各模型直接推出工作流功能 | 🔴 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 企業採購要求 SOC 2 而本產品無法承諾 | 🟠 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 概念很漂亮但不會形成習慣 | 🟡 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 模板缺乏產業專精，無法勝過 Notion | 🔴 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 沒有執行能力而被視為文件工具 | 🟠 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 多 persona 導致訊息與產品都模糊 | 🟡 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| sweet=2 下沉沒成本與開發衝動 | 🔴 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |

### 7.2 ⭐ ADR (Architecture Decision Records)

本節明確記錄 sweet=2 的取捨：競品 CrewAI、ChatGPT Team、Claude for Teams 已在原紅海取得優勢，因此每個決策都必須服務於「不賣 AI 團隊名詞或模板市集，只提供一個「工作流責任矩陣」：把一人公司的固定任務、輸入、人工檢查點與可用工具寫成可執行的 operating playbook。」。
#### ADR-001
**Decision**：ADR-001：從 AI role directory 改為 responsibility matrix；因 sweet=2 顯示「介紹」不是可付費結果。
...
#### ADR-002
**Decision**：ADR-002：MVP 不直接執行 Agent；避免和 CrewAI/Hermes 正面競爭，先測 playbook 留存。
**Context**：sweet spot 5 問體檢顯示，追求更寬功能會增加成本而不增加證據。
**Trade-off**：短期可展示功能較少，但能測到真實 job、信任與回購。
**Reversal trigger**：若指定指標未達標，回到 discovery；若達標才允許擴充。

#### ADR-003
**Decision**：ADR-003：只選一人公司，不承諾企業安全；以誠實的定位降低 SOC 2 風險。
**Context**：sweet spot 5 問體檢顯示，追求更寬功能會增加成本而不增加證據。
**Trade-off**：短期可展示功能較少，但能測到真實 job、信任與回購。
**Reversal trigger**：若指定指標未達標，回到 discovery；若達標才允許擴充。

#### ADR-004
**Decision**：ADR-004：先驗證再開發門檻為 10 位中至少 6 位在第二週重用同一 playbook。
**Context**：sweet spot 5 問體檢顯示，追求更寬功能會增加成本而不增加證據。
**Trade-off**：短期可展示功能較少，但能測到真實 job、信任與回購。
**Reversal trigger**：若指定指標未達標，回到 discovery；若達標才允許擴充。
...
| 方案 | 價格 | 限制/價值 | 觸發升級 |
|---|---|---|---|
| 免費：5 個任務與 JSON 匯出 | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
| 個人：NT$149/月，無限 playbook 與週回顧 | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
| 顧問：NT$699/月，10 個客戶 snapshot | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
| 不提供企業版，直到安全需求訪談完成 | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
...
|---|---|---|---|
| CrewAI | 規模/習慣/通用功能 | 紅海主功能 | 本案 wedge |
| ChatGPT Team | 規模/習慣/通用功能 | 紅海主功能 | 本案 wedge |
| Claude for Teams | 規模/習慣/通用功能 | 紅海主功能 | 本案 wedge |
| 本專案 | 不賣 AI 團隊名詞或模板市集，只提供一個「工作流責任矩陣」：把一人公司的固定任務、輸入、人工檢查點與可用工具寫成可執行的 operating playbook。 | 不承諾全市場 | 需用 §11 證明 |
...
quadrantChart
    ...
    quadrant-4 "昂貴複雜"
    "CrewAI": [0.15, 0.25]
    "ChatGPT Team": [0.27, 0.33]
    "Claude for Teams": [0.39, 0.41]
    "本專案": [0.85, 0.85]
```
...
- CrewAI 官方首頁在本次 quick check 可連線並導向 crewai.com（HTTP 200），確認企業級 Agent 敘事仍活躍。
- 原分析指出 CrewAI 已達 Fortune 500 的 63%；因此本版把企業功能列為反需求，而非追趕 roadmap。
- 原分析指出 8 種產業 persona 模糊；本版只選一人公司，並以可重用 playbook 作唯一核心指標。
...
本計畫由 sweet=2 與競品 CrewAI、ChatGPT Team、Claude for Teams 反推；目的不是證明產品存在，而是證明指定 wedge「不賣 AI 團隊名詞或模板市集，只提供一個「工作流責任矩陣」：把一人公司的固定任務、輸入、人工檢查點與可用工具寫成可執行的 operating playbook。」能產生重複行為與付款。
### 11.1 驗證前 3 個關鍵問題

1. **誰在最近 30 天真的遇到這個 job，且目前用什麼替代？**
   - 證據：企業端需要資安與 SOC 2；CrewAI 已進入大量 Fortune 500，而「8 種產業 persona」過於模糊，單純介紹 AI 角色沒有購買理由。
...
**Target 1：4 位一人 SaaS 創辦人**
- 先問最近一次事件，不先展示功能。
- 記錄目前工具、步驟、耗時、錯誤與替代成本。
- 展示一個 5 分鐘 prototype，觀察是否主動完成下一步。
- 結束只問 willingness-to-pay 與願不願提供資料，不引導答案。

**Target 2：4 位自媒體/內容工作者**
- 先問最近一次事件，不先展示功能。
- 記錄目前工具、步驟、耗時、錯誤與替代成本。
- 展示一個 5 分鐘 prototype，觀察是否主動完成下一步。
- 結束只問 willingness-to-pay 與願不願提供資料，不引導答案。

**Target 3：3 位 AI 顧問與培訓師**
- 先問最近一次事件，不先展示功能。
- 記錄目前工具、步驟、耗時、錯誤與替代成本。
- 展示一個 5 分鐘 prototype，觀察是否主動完成下一步。
- 結束只問 willingness-to-pay 與願不願提供資料，不引導答案。

**Target 4：3 位已用 Notion/ChatGPT 管理流程者**
- 先問最近一次事件，不先展示功能。
- 記錄目前工具、步驟、耗時、錯誤與替代成本。
- 展示一個 5 分鐘 prototype，觀察是否主動完成下一步。
- 結束只問 willingness-to-pay 與願不願提供資料，不引導答案。

**Target 5：6 位企業 IT/資安人員（只做反需求訪談）**
- 先問最近一次事件，不先展示功能。
- 記錄目前工具、步驟、耗時、錯誤與替代成本。
- 展示一個 5 分鐘 prototype，觀察是否主動完成下一步。
- 結束只問 willingness-to-pay 與願不願提供資料，不引導答案。
...
- 主題：在一人公司社群發文：「你把 AI 工具放進哪一個固定工作流？哪個人工檢查點不能省？」
- 先發問題與匿名結果，不把 landing page 寫成廣告。
- 成功：至少 20 個有情境回覆、5 人願意進 pilot、反對理由可分類。

### 11.4 Landing page test

- 測試：以「把一個固定工作寫成 10 分鐘可交接 SOP」與「AI 團隊」兩個標題做測試，驗證 responsibility matrix 是否勝過泛模板。
...
**MUST（P0）**
- MUST-01 任務目錄：每個任務一個 owner、輸入、輸出與人工檢查點
- MUST-02 五種真實 playbook：內容、客戶回覆、產品規格、開發、週報
- MUST-03 角色不是 AI 人格，而是工作責任與工具清單
- MUST-04 依任務記錄實際完成時間與工具成本
- MUST-05 流程圖可視化但不自動執行
- MUST-06 一鍵複製模板與 Markdown/JSON 匯出
- MUST-07 任務版本、決策理由與變更紀錄
- MUST-08 本地 IndexedDB，明確標示不等於企業合規產品
- MUST-09 每週回顧頁，顯示卡住的責任交接
- MUST-10 用 10 位使用者的實際任務資料驗證模板

**SHOULD（P1）**
- SHOULD-01 雲端同步與分享連結
- SHOULD-02 顧問客戶 workspace 對照表
- SHOULD-03 Slack/Notion 單向匯出
- SHOULD-04 playbook 完成率與 bottleneck 分析
- SHOULD-05 可列印的 SOP 報告
- SHOULD-06 小型團隊 3 席方案

**MAY（P2）**
- MAY-01 企業治理 connector
- MAY-02 權限與審計
- MAY-03 Agent 執行 adapter
- MAY-04 模板交易
...
- REQ-POOL-001：雲端同步與分享連結
- REQ-POOL-002：顧問客戶 workspace 對照表
- REQ-POOL-003：Slack/Notion 單向匯出
- REQ-POOL-004：playbook 完成率與 bottleneck 分析
- REQ-POOL-005：可列印的 SOP 報告
- REQ-POOL-006：小型團隊 3 席方案
- REQ-POOL-007：企業治理 connector
- REQ-POOL-008：權限與審計
- REQ-POOL-009：Agent 執行 adapter
- REQ-POOL-010：模板交易
- REQ-POOL-011：匿名基準資料
- REQ-POOL-012：顧問模式
- REQ-POOL-013：進階匯入
...
- 主要競品：CrewAI、ChatGPT Team、Claude for Teams。
- 競品優勢不是推測，而是公開產品入口、成熟使用習慣或原分析的競品清單。
- 本案決定不追逐其最強維度，改用 wedge：不賣 AI 團隊名詞或模板市集，只提供一個「工作流責任矩陣」：把一人公司的固定任務、輸入、人工檢查點與可用工具寫成可執行的 operating playbook。
### 15.2 五問二：使用者為何還會換？

- 已知 gap：企業端需要資安與 SOC 2；CrewAI 已進入大量 Fortune 500，而「8 種產業 persona」過於模糊，單純介紹 AI 角色沒有購買理由。
- 可換理由必須是具體 job 的時間、錯誤、回流或合規成本；「AI 很酷」不算。
- 研究訪談需請使用者展示最近一次原流程，禁止只做偏好問卷。
### 15.3 五問三：甜蜜點是否比競品更窄、更可交付？

- 窄定位：不賣 AI 團隊名詞或模板市集，只提供一個「工作流責任矩陣」：把一人公司的固定任務、輸入、人工檢查點與可用工具寫成可執行的 operating playbook。
- MVP 僅包含：任務目錄：每個任務一個 owner、輸入、輸出與人工檢查點；五種真實 playbook：內容、客戶回覆、產品規格、開發、週報；角色不是 AI 人格，而是工作責任與工具清單；依任務記錄實際完成時間與工具成本；流程圖可視化但不自動執行。
- 排除：不做企業級 Agent 執行平台；不做 SOC 2、SSO、審計與多租戶承諾；不做 8 種產業的泛 persona 模板；不做模板市集、創作者分成或社群。
- 這是 sweet=2 的直接回應：分數越低，範圍越小、人工驗證越前置。
### 15.4 五問四：誰會付費、用什麼預算？

- 初始付費設計：
  - 免費：5 個任務與 JSON 匯出
  - 個人：NT$149/月，無限 playbook 與週回顧
  - 顧問：NT$699/月，10 個客戶 snapshot
  - 不提供企業版，直到安全需求訪談完成
...
- 證據：不先承諾 ARR。成功條件是 4 週內 10 位使用者完成 3 次回顧、6 位重用 playbook、3 位願意付 NT$149；否則維持文件/開源狀態，不再擴充。
...
- 目標人群：已有 3 個以上 AI 工具、每週重複產出內容或程式、但沒有團隊制度的一人公司經營者與 AI 顧問。
- 市場策略：先完成 5 組指定訪談，再用行為漏斗估算可服務市場。
- 不把全球使用者、下載量或競品估值直接乘上採用率。
- 可觸達通路：在一人公司社群發文：「你把 AI 工具放進哪一個固定工作流？哪個人工檢查點不能省？」

### 15.8 收益情境與 unit economics

- 不先承諾 ARR。成功條件是 4 週內 10 位使用者完成 3 次回顧、6 位重用 playbook、3 位願意付 NT$149；否則維持文件/開源狀態，不再擴充。
...
| E-01 | CrewAI 官方首頁在本次 quick check 可連線並導向 crewai.com（HTTP 200），確認企業級 Agent 敘事仍活躍。 | 對應 §1.1/§3.1/§11 |
| E-02 | 原分析指出 CrewAI 已達 Fortune 500 的 63%；因此本版把企業功能列為反需求，而非追趕 roadmap。 | 對應 §1.1/§3.1/§11 |
| E-03 | 原分析指出 8 種產業 persona 模糊；本版只選一人公司，並以可重用 playbook 作唯一核心指標。 | 對應 §1.1/§3.1/§11 |
